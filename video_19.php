...
if (!isset($_SESSION["login"])) {
  header("Location: video_19/login.php");
  exit;
}
require 'video_19/functions.php';
...
<head>
  ...
  <link rel="stylesheet" href="video_19/style.css">
</head>
...
<body>
  ...
  <div class="container">
    ...
    <a href="video_19/logout.php" class="logout">Logout</a>
    <a href="video_19/tambah.php" class="tambah">Tambah Data Buku</a>
    <table border="1" cellpadding="10" cellspacing="0">
      ...
      <?php foreach ($books as $book) : ?>
        <?php if ($i % 2 == 0) : ?>
          ...
          <td class="angka"><?= $i; ?></td>
          <td>
            <a href="video_19/ubah.php?id=<?= $book["id"]; ?>" class="ubah">Ubah</a>
            <a href="video_19/hapus.php?id=<?= $book["id"]; ?>" onclick="return confirm('yakin?');" class="hapus">Hapus</a>
          </td>
